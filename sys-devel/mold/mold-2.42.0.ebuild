...
# mimalloc: raised from >=2 (what 2.41.0 needed) because CMakeLists.txt now
# calls find_package(mimalloc 3 REQUIRED) -- v2 does not use transparent huge
# pages for the allocations that dominate large links.
RDEPEND="
	app-arch/zstd:=
