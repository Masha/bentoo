...
# Do NOT drop this version when bumping dev-lang/dart. dev-lang/flutter pins the
# exact Dart SDK it was built against (~dev-lang/dart-3.12.2) because it runs the
# pre-built flutter_tools snapshot on the system Dart VM, and a snapshot only
# loads on the VM it was compiled for. Flutter stable still ships 3.12.2; this
# version may only be removed once no dev-lang/flutter ebuild depends on it.
