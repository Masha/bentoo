...
DESCRIPTION="Cargo subcommand that injects bugs to find gaps in test coverage"
HOMEPAGE="https://mutants.rs/"
SRC_URI="https://github.com/sourcefrog/cargo-mutants/archive/refs/tags/v${PV}.tar.gz -> ${P}.tar.gz"
...
QA_FLAGS_IGNORED="usr/bin/cargo-mutants"
