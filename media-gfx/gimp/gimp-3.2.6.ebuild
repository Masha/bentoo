...
# BENTOO-DIVERGENCE: COMMON_DEPEND - the gdk-pixbuf floor below is 2.32.0,
# where ::gentoo 3.2.4 has 2.30.8. Not a judgement call: gdk_pixbuf_minver
# in 3.2.6's own meson.build went 2.30.8 -> 2.32.0, and it is the ONLY floor
# that moved between the two releases. Re-diff the _minver block on each bump.
# Keep this comment OUT of the depset string: a "#" inside DEPEND/RDEPEND is
# not a comment, it is an atom, and pkgcheck rejects the whole depset.
COMMON_DEPEND="
	${PYTHON_DEPS}
	$(python_gen_cond_dep '
